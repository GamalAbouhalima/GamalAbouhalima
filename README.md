...
Focused on **ASP.NET Core**, **C#**, and **SQL Server**.
...
| Project | Description |
|---------|-------------|
| Console Apps | Practice small programs in C# |
| ASP.NET Core Web API | CRUD operations & learning API development |
| Database Projects | Connecting apps with SQL Server |
